...
# Generated by qmake (3.0) (Qt 5.1.1) on: Sun Nov 10 16:03:49 2013
# Project:  Gomoku.pro
# Template: app
...
INCPATH       = -I/usr/lib64/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.moc -I.ui
LINK          = g++
...
SOURCES       = main.cpp \
		...
		player.cpp \
		arbiter.cpp \
		changecolor.cpp .moc/moc_mainwindow.cpp \
		.moc/moc_frame.cpp
OBJECTS       = .obj/main.o \
		.obj/mainwindow.o \
		.obj/frame.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/Gomoku1.0.0/ && $(COPY_FILE) --parents mainwindow.h frame.h player.h arbiter.h changecolor.h .obj/Gomoku1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp frame.cpp player.cpp arbiter.cpp changecolor.cpp .obj/Gomoku1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .obj/Gomoku1.0.0/ && (cd `dirname .obj/Gomoku1.0.0` && $(TAR) Gomoku1.0.0.tar Gomoku1.0.0 && $(COMPRESS) Gomoku1.0.0.tar) && $(MOVE) `dirname .obj/Gomoku1.0.0`/Gomoku1.0.0.tar.gz . && $(DEL_FILE) -r .obj/Gomoku1.0.0
...
compiler_moc_header_make_all: .moc/moc_mainwindow.cpp .moc/moc_frame.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) .moc/moc_mainwindow.cpp .moc/moc_frame.cpp
...
.ui/ui_mainwindow.h: mainwindow.ui
	/usr/lib64/qt5/bin/uic mainwindow.ui -o .ui/ui_mainwindow.h
